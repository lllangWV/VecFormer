...
output "results_download_command" {
  description = "Command to download results"
  value       = "aws s3 sync s3://${module.s3_bucket.bucket_name}/results/${var.run_id}/ ./results/${var.run_id}/"
}
